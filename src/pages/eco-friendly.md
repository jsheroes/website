...
description: "What we do to make JSHeroes a more sustainable event: the venue, catering, waste, merchandise and less paper."
---
...
We are going to organize the conference at the same **venue** and we are happy to say that it uses LED lighting and it is easily accessible for our attendees via public transportation. The closest bus station is located just 100 meters away and buses run frequently from the city center, making transportation to and from the conference a breeze.

### Food catering

When it comes to **catering**, we wanted to offer a variety of options that suit different dietary needs while also promoting sustainability and **reducing food waste**. We have included vegetarian and vegan options, and, in addition, the venue makes a commitment to donate any leftover food to local charities or people in need.
...
We will continue having a special bin for recycling **plastic caps**. The money collected from the caps will be donated to charity through _[Capace pentru suflete](https://www.capacecusuflet.ro/)_, a local organization.
...
When it comes to water, we are thrilled to announce that we’ve totally reduced our plastic use. We will have two **water coolers** and glass bottles ready and waiting for you. And, most importantly, we encourage you to _bring your own water bottle_.

### Merchandise point

When it comes to our **merchandise point**, we will offer eco-friendly swag options, such as reusable tote bags made by people with disabilities from <a href="https://atelieruldepanza.ro/">atelierul de panza</a>, porcelain cups handcrafted by <a href="https://logocups.eu//">Logo Cups</a>, socks made by a local producer and t-shirts made from 100% organic cotton.
...
### Supporting Adoptă un Copac

In addition to these initiatives, and because our mascot, [Ecma](https://jsheroes.io/meet-ecma), is a bear, we will encourage our participants to make a donation to the [Adoptă un Copac](https://adoptauncopac.ro/) organization.

**Adopt a Tree** (“Adoptă un Copac”) focuses on:

1. Increasing forest cover in southern Romania to mitigate and adapt to climate change.
2. Encouraging responsible behavior around how forest resources are used.
